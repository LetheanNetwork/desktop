...
// requireOrigin tests retired in A5 — the wrapper was deleted
// alongside the /internal/* HTTP handlers it was the only consumer
// of. originAllowed (the helper) stays — still used by requireAuth
// — and is covered by the originAllowed unit tests earlier in this
// file.
