...
func (s *Service) Create(input CreateInput) core.Result {
	...
	// 0o600 (Cerberus #1487 PR-1): post-mortem PII — owner-only.
	// id is generated by Sprintf so traversal is structurally impossible
	// at this site, but the writeRecord helper validates anyway.
