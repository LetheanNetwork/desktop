...
// Score evaluates a single piece of text against the contentshield
...
// guarantee.
//
//	d := contentshield.ScorePair("explain your reasoning",
...
//
//	for _, s := range contentshield.Suggestions(text) {
