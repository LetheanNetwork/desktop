...
//
//	contentshield.IsKnownDialectContraction("y'all")        // true
//	contentshield.IsKnownDialectContraction("AIN'T")        // true (case-insensitive)
//	contentshield.IsKnownDialectContraction("Cina-Gia'a")   // false (not English dialect)
//	contentshield.IsKnownDialectContraction("frabbis'nork") // false (invented)
//
