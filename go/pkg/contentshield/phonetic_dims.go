...
// Usage example:
//
//	n := contentshield.SyllableCount("Cat sat on a mat")
//	// 5 — five monosyllabic words
//
//	n = contentshield.SyllableCount("banana piano")
...
// Usage example:
//
//	reach := contentshield.PhoneticReach(
...
// Usage example:
//
//	e := contentshield.SigilEntropy("Hello world", 32)
//	// e ≈ 3.0 (English text)
//	e = contentshield.SigilEntropy("iN\x01g\xa1'tg\xa1iThe answer is...", 32)
...
// Usage example:
//
//	r := contentshield.RhymeDensity("The cat\nsat on the mat\nin the night")
...
// Usage example:
//
//	d := contentshield.AlliterationDensity("she sells sea shells")
...
// Usage example:
//
//	d := contentshield.AssonanceDensity("I see three free trees")
...
// Usage example:
//
//	d := contentshield.PunDensity("I scream for ice cream")
...
// Usage example:
//
//	d := contentshield.PseudoJargonDensity(
...
// Usage example:
//
//	d := contentshield.MeterRegularity("My mistress' eyes are nothing like the sun")
