...
//
//	contentshield.Pattern{Phrase: "you nailed it", Tier: contentshield.TierHollowFlattery}
type Pattern struct {
...
//
//	for _, p := range contentshield.SycophancyPatterns { ... }
...
//
//	for _, p := range contentshield.ContentShieldPatterns { ... }
