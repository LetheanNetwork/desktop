...
// ScoreResult is the unified contentshield scoring output for a single
...
// as their port ships.
//
//	r := contentshield.Score("you're absolutely right, I was wrong")
...
//
//	d := contentshield.ScorePair(userPrompt, aiResponse)
...
// contentshield.suggestions action — span-level Suggestion list only,
