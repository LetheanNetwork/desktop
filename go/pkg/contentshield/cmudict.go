...
// Usage example:
//
//	ph, ok := contentshield.Lookup("banana")
//	if ok { /* ph = [B AH0 N AE1 N AH0] */ }
//
//	ph, ok = contentshield.Lookup("nonexistent")
//	// ok = false
...
// Usage example:
//
//	if !contentshield.IsDictWord("Cina-Gia'a") {
...
// Usage example:
//
//	if contentshield.IsVowelPhoneme("AE1") { /* stressed AE */ }
...
// Usage example:
//
//	contentshield.PhonemeStress("AE1") // 1 (primary stress)
//	contentshield.PhonemeStress("AH0") // 0 (unstressed)
//	contentshield.PhonemeStress("K")   // -1 (consonant)
