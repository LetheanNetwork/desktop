...
// Usage example:
//
//	p, s, ok := contentshield.DoubleMetaphone("Thompson")
//	// p = "TMSN", s = "TMSN", ok = true
//
//	p, _, _ := contentshield.DoubleMetaphone("Smith")
//	p2, _, _ := contentshield.DoubleMetaphone("Smyth")
...
// Usage example:
//
//	if contentshield.PhoneticEquivalent("Smith", "Smyth") {
...
// Usage example:
//
//	if contentshield.PhoneticContains("Cina-Gia'a", "China") {
