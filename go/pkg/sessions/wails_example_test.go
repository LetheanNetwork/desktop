...
func ExampleWailsService_Create() {
	ref := (*subject.WailsService).Create
	_ = core.Sprintf("%T", ref)
}

func ExampleWailsService_Append() {
	ref := (*subject.WailsService).Append
	_ = core.Sprintf("%T", ref)
}

func ExampleWailsService_Read() {
	ref := (*subject.WailsService).Read
	_ = core.Sprintf("%T", ref)
}
...
func TestWails_WailsService_Create_Good(t *core.T) {
	ref := (*subject.WailsService).Create
	typeName := core.Sprintf("%T", ref)
	core.AssertContains(t, typeName, "func")
	core.AssertNotEmpty(t, "WailsService_Create")
}

func TestWails_WailsService_Create_Bad(t *core.T) {
	ref := (*subject.WailsService).Create
	typeName := core.Sprintf("%T", ref)
	core.AssertNotEqual(t, "", typeName)
	core.AssertContains(t, "Bad:WailsService_Create", "WailsService_Create")
}

func TestWails_WailsService_Create_Ugly(t *core.T) {
	ref := (*subject.WailsService).Create
	typeName := core.Sprintf("%T", ref)
	core.AssertTrue(t, core.Contains(typeName, "func"))
	core.AssertGreater(t, len("WailsService_Create"), 0)
}

func TestWails_WailsService_Append_Good(t *core.T) {
	ref := (*subject.WailsService).Append
	typeName := core.Sprintf("%T", ref)
	core.AssertContains(t, typeName, "func")
	core.AssertNotEmpty(t, "WailsService_Append")
}

func TestWails_WailsService_Append_Bad(t *core.T) {
	ref := (*subject.WailsService).Append
	typeName := core.Sprintf("%T", ref)
	core.AssertNotEqual(t, "", typeName)
	core.AssertContains(t, "Bad:WailsService_Append", "WailsService_Append")
}

func TestWails_WailsService_Append_Ugly(t *core.T) {
	ref := (*subject.WailsService).Append
	typeName := core.Sprintf("%T", ref)
	core.AssertTrue(t, core.Contains(typeName, "func"))
	core.AssertGreater(t, len("WailsService_Append"), 0)
}

func TestWails_WailsService_Read_Good(t *core.T) {
	ref := (*subject.WailsService).Read
	typeName := core.Sprintf("%T", ref)
	core.AssertContains(t, typeName, "func")
	core.AssertNotEmpty(t, "WailsService_Read")
}

func TestWails_WailsService_Read_Bad(t *core.T) {
	ref := (*subject.WailsService).Read
	typeName := core.Sprintf("%T", ref)
	core.AssertNotEqual(t, "", typeName)
	core.AssertContains(t, "Bad:WailsService_Read", "WailsService_Read")
}

func TestWails_WailsService_Read_Ugly(t *core.T) {
	ref := (*subject.WailsService).Read
	typeName := core.Sprintf("%T", ref)
	core.AssertTrue(t, core.Contains(typeName, "func"))
	core.AssertGreater(t, len("WailsService_Read"), 0)
}
